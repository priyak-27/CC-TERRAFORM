...
resource "aws_instance" "server" {
  ...
  provisioner "file" {
    source      = "/Users/priya/Desktop/CC-TERRAFORM/project1/"  # add all file from project1 folder to remote folder
    destination = "/home/ubuntu/"  # path on the remote instance
  }
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "mkdir -p /home/ubuntu/project1/scripts", # Create the directory for your project
      "mkdir -p /home/ubuntu/project1/templates",  # Create the directory for your project
      "mv /home/ubuntu/cc.py /home/ubuntu/project1/scripts/cc.py",  # Move cc.py into the project1/scripts folder
      "mv /home/ubuntu/graph.py /home/ubuntu/project1/scripts/graph.py",
      "mv /home/ubuntu/form.html /home/ubuntu/project1/templates/form.html",
      "mv /home/ubuntu/app.py /home/ubuntu/project1/app.py",
      "cd /home/ubuntu/project1",
      "sudo pip3 install flask",
      "sudo pip3 install networkx pyvis",
